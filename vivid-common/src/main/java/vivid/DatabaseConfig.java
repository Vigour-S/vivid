...
class StandaloneDatabaseConfig extends DatabaseConfig {
    ...
    public DataSource dataSource() {
        ...
        dataSource.setUrl("jdbc:h2:mem:vivid;MODE=PostgreSQL");
...
@Configuration
@Profile(VividProfiles.CLOUDFOUNDRY)
class CloudFoundryDatabaseConfig extends DatabaseConfig {
    ...
    @Bean
    public DataSource dataSource() {
        DataSource dataSource = cloud().getServiceConnector("vivid-db", DataSource.class, null);
